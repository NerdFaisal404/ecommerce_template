...
class TextStyles {
  ...
  static TextStyle noBold20({Color color}) =>
      GoogleFonts.varelaRound(color: _getColor(color), fontSize: 20);
  static TextStyle noBold18({Color color}) =>
      GoogleFonts.varelaRound(color: _getColor(color), fontSize: 18);
  static TextStyle noBold16({Color color}) =>
      GoogleFonts.varelaRound(color: _getColor(color), fontSize: 16);
  static TextStyle noBold14({Color color}) =>
      GoogleFonts.varelaRound(color: _getColor(color), fontSize: 14);
  static TextStyle noBold12({Color color}) =>
      GoogleFonts.varelaRound(color: _getColor(color), fontSize: 12);
